...
module.exports = function (defaultFuncs, api, ctx) {
		...
		defaultFuncs
			...
			.then(function (resData) {
				...
				var messageInfo = resData.payload.actions.reduce(function (
					...
					return (
						{
							threadID: v.thread_fbid || threadID,
	...
	function send(form, threadID, messageAndOTID, callback, isGroup) {
		// need someones help :v
		if (utils.getType(threadID) === 'Array')
			sendContent(form, threadID, false, messageAndOTID, callback);
		else {
			var THREADFIX = 'ThreadID'.replace('ThreadID', threadID); // idk ???
	...
	/* 
    * UID Facebook !== ThreadID Facebook
    ! utils.getType(threadID) return undefined
    */
